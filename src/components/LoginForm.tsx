...
import { Eye, EyeOff, User, Lock, Cpu, Shield, Users, UserPlus, Mail, Hash, Phone, ArrowLeft, Send } from 'lucide-react';
...
const LoginForm: React.FC = () => {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setResetMessage('Password reset instructions have been sent to your email address. Please check your inbox and follow the instructions to reset your password.');
      setResetEmail('');
    } catch (err) {
            ...
            {resetMessage ? (
              ...
              >
                ...
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-peacock-500 to-blue-500 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-2xl transition-all duration-300"
                >
              ...
              <form onSubmit={handleForgotPassword} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <motion.button
                    ...
                    type="button"
                    onClick={goBackToLogin}
                    className="w-full bg-dark-700/50 border border-dark-600 text-peacock-300 py-4 rounded-xl font-semibold hover:bg-dark-600/50 hover:text-white transition-all duration-300"
                  >
                    <div className="flex items-center justify-center gap-3">
                      <ArrowLeft className="w-5 h-5" />
                      Back to Login
          ...
          {!isRegistering && (
            ...
            >
              <button
                ...
                className="text-peacock-400 hover:text-peacock-300 transition-colors font-medium text-sm"
              >
